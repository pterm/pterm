...
func main() {
	// Since GitHub does not use a monospace font, we need to overwrite
	// the horizontal character for the automatic generation of the SVG animations.
	// You can remove this overwrite in your application.
	pterm.DefaultBox = *pterm.DefaultBox.WithHorizontalString("-")
