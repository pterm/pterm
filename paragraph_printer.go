...
func (p ParagraphPrinter) Print(a ...interface{}) GenericPrinter {
	Print(p.Sprint(a...))
	return &p
}
...
// Spaces are always added between operands and a newline is appended.
// It returns the number of bytes written and any write error encountered.
func (p ParagraphPrinter) Println(a ...interface{}) GenericPrinter {
	Println(p.Sprint(a...))
	return &p
}
...
// It returns the number of bytes written and any write error encountered.
func (p ParagraphPrinter) Printf(format string, a ...interface{}) GenericPrinter {
